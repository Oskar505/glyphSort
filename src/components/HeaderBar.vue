    ...
    <header>
        <div class="headerContainer">
            ...
            <nav v-if="showNav">
                ...
                <div @click="this.$router.push({path:'/sort', query: {glyphSetIds: JSON.stringify(selectedGlyphs)}})"><h2 :class="activeBtn == 1 ? 'navActive' : '' ">Evaluate</h2></div>
